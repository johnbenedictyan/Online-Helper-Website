...
STRIPE_WEBHOOK_KEY = os.environ.get('STRIPE_WEBHOOK_SECRET_KEY')
...
# API Account UUID V5 Namespace
API_ACCOUNT_UUID_NAMESPACE = os.environ.get('API_ACCOUNT_UUID_NAMESPACE')
