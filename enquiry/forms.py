...
class GeneralEnquiryForm(forms.Form):
    ...
    maid_responsibility = forms.MultipleChoiceField(
    ...
    maid_age_group = forms.ChoiceField(
        label=_('Maid Age Group'),
        required=True,
        choices=MAID_AGE_CHOICES
    )

    rest_days = forms.ChoiceField(
        label=_('Number of Rest Days'),
        required=True,
        choices=MAID_REST_DAY_CHOICES
    )
    
    no_of_family_members = forms.IntegerField(
        label=_('Number of Family Members'),
        required=True,
    ...
    no_of_below_12 = forms.IntegerField(
        label=_('Number of Children below 12'),
        required=True,
        widget=forms.NumberInput(
            attrs={
    ...
    no_of_babies = forms.IntegerField(
        label=_('Number of Babies'),
        required=True,
        widget=forms.NumberInput(
            attrs={
